    ...
    <Card className="divide-y divide-line p-0">
      <div className="flex items-center justify-between gap-4 px-4 py-3.5">
        <div className="min-w-0 space-y-0.5">
          <p className="text-base font-bold text-ink">المظهر</p>
          <p className="text-xs leading-relaxed text-muted">التبديل بين الوضع الفاتح والداكن.</p>
        </div>
      ...
      <div className="flex items-center justify-between gap-4 px-4 py-3.5">
        <div className="min-w-0 space-y-0.5">
          <p className="text-base font-bold text-ink">الكثافة</p>
          <p className="text-xs leading-relaxed text-muted">مريحة افتراضيًا، مضغوطة لعرض محتوى أكثر.</p>
        </div>
        <DensityPill
          value={density}
          disabled={busy}
